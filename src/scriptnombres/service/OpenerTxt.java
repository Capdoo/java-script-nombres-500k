...
public class OpenerTxt {
        ...
        private List<Paciente> listaGeneral = new ArrayList<>();
        private String nombres = "Nombres.txt";
        private String apellidos = "Apellidos.txt";
        private String residual = "Residual.txt";
                      ...
                      try{
                              ...
                              for(int i=0;i<20;i++){
                                      ...
                                      pacientex = new Paciente();
                                        ...
                                        pacientex.setDni(asignarDni(edad));
